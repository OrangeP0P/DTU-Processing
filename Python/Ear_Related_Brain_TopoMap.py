...
######################### 步骤1: 读取.mat文件 ########################
data_path = 'D:\DTU Data\EEGLab Array Format\All Data of Each Subject with One Ear/'
data_name = ['S1_Left-Ear', 'S1_Right-Ear']
data_ID = 1
...
plt.savefig('Figure-TopoMap/Ear Topo Map/'+'EarMap_'+data_name[data_ID]+'.eps', dpi=600)